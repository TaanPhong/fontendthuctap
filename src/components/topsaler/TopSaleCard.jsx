...
const TopSaleCard = () => {
    ...
    useEffect(callAPI, [])
    function callAPI() {
        axios.get("http://localhost:8081/product/top/sale")
            .then(res => {
                                ...
                                <div className="product" >
                                    ...
                                    <div className="detailProduct">
                                        ...
                                        <div className="priceProduct">
                                            {
                                                productItem.precentPromotion ? <h4 style={{ textDecoration: "line-through", color: "#ad9191", fontWeight: 500 }}>{productItem.price.toLocaleString('vi-VN', {
                                                    style: 'currency',
                                                    currency: 'VND'
                                                })}</h4>
                                                    : <></>
                                        ...
                                        <div className='priceProduct'>
                                            {
                                                productItem.precentPromotion ? <h4>{(productItem.price * productItem.precentPromotion / 100).toLocaleString('vi-VN', {
                                                    style: 'currency',
                                                    currency: 'VND'
                                                })}</h4>
